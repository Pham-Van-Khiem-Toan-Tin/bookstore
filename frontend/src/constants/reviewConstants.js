...
export const REVIEW_WATCH_MORE_REQUEST = "REVIEW_WATCH_MORE_REQUEST";
export const REVIEW_WATCH_MORE_SUCCESS = "REVIEW_WATCH_MORE_SUCCESS";
export const REVIEW_WATCH_MORE_FAIL = "REVIEW_WATCH_MORE_FAIL";
